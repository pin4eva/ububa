...
export const productsData: IProductsData[] = [
	{
		...
		productDesc:
			"Ububa  Technologies has reputable proficieny in the development of custom software solutions, portals, e-commerce applications, business application and automation oftware...",
	},
	{
		id: 2,
		productTitle: "Mobile App Dev.",
		productDesc:
	...
	{
		id: 4,
		productTitle: "Ecommerce Website Dev.",
		productDesc:
